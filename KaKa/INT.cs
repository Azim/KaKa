...
namespace KaKa
{
    public partial class INT : Form
    {
        ...
        private void IDC_INP_Click(object sender, EventArgs e)
        {
            ...
            //IDC_BACK.Enabled = IDC_EXPLORER.CanGoBack;
            //IDC_FORWARD.Enabled = IDC_EXPLORER.CanGoForward;
        }
        ...
        private void IDC_EXPLORER_ProgressChanged(object sender, WebBrowserProgressChangedEventArgs e)
        {
            ...
            {
                IDC_PROGRESS.Value = (int)(e.CurrentProgress * 100 / e.MaximumProgress); //выдаёт ошибку, CurrentProgress больше максимума 
            }
            else
            {
